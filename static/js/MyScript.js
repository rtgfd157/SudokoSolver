$(document).ready(function () {
    ...
    $("#reset").click(function () { CleanTable() ;

        $("#insertnumbers").removeAttr('disabled');
    ...
    $("#checkTable").click(function () {
        ...
        var chek_tab_bol = checkTable();
           ...
           $('#calculating_mess').css('visibility','visible');
           //var a='ff'
           //document.getElementById('calculating_mess').value = a;
           calculating_mess.innerText = "calculating...";

             $("#checkTable").prop("disabled",true);
             $("#insertnumbers").prop("disabled",true);
...
// make just 1-9 as good input
    ...
    function CleanTable() {
        //debugger
        $('#calculating_mess').css('visibility','hidden');
        for (var i = 1; i < 82; i++) {

            var element = document.getElementById('i3' + i);

            $("#i3" + i).css("background-color", "White");
            // document.getElementById("#i3" + i).readOnly = true;
            // document.getElementById("#i3" + i).setAttribute("readonly", true);
